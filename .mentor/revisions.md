...
- SQL : `INNER JOIN` (matches des 2 tables) vs `LEFT JOIN` (toutes les lignes de gauche, `NULL` sinon) ; **condition de jointure = `ON` (JAMAIS `WHERE`)** — vu séance 36 — dernière révision : 2026-09-22 séance 37 (**a REMIS `WHERE` → driller +++**)
