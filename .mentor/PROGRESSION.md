...
- **Robustesse du capstone** : `try`/`except` (saisie invalide) + messages « aucune machine trouvée/modifiée/supprimée » (`cursor.rowcount` / `fetchall` vide). Puis LEFT JOIN, compléments Python (`pathlib`, `pip`, POO).
